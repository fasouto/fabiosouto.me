...
Everything is getting faster: media, relationships, trends... For some time I thought coding was immune to that. I was absolutely wrong...

A month ago I refactored a small project with Claude Code. It was amazing. A couple of prompts, tests passed, deployed, moved on. A week passed and the server started crashing. Memory leak. I opened the project and I had no idea how to diagnose it, honestly I had no idea where to start.
...
Maybe the worst offender (at least for me) are AI-generated tests. I've seen it create a mock and then test the mock. Or tests that assert the function returns what it returns. Circular nonsense that looks like coverage but tests nothing. If you're not paying attention, you'll merge it and feel good about your test suite.
...
I had the code for [RandomWheel](https://randomwheel.com/) sitting around for years with an outdated version of Nuxt. I needed to add moderation, so I rebuilt from scratch with Claude Code. <SideNote>people were submitting adult wheels 🤦</SideNote>
