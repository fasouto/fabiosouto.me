...
A month ago I refactored a small project with Claude Code. It felt like magic. A couple of prompts → tests passed → deployed → moved on. A week later, the server started crashing. Memory leak. <SideNote>i18n issue</SideNote> I opened the project and had absolutely no idea where to start.
...
AI handles the first bucket well. I rebuilt [RandomWheel](https://randomwheel.com/) from scratch with Claude Code. Small, familiar, easy to verify. Almost one-shotted.
